...
parsed_parameters = {"cloud_provider": "aws", "region": "us-east-1", "environment": "dev", "ticket_number": "test-ticket-123", "tcp_upload": "yes", "ssl_terminate_f5": "no", "fqdn": "first.app.deloitte.com", "health_monitor": "https", "load_balancing_method": "round-robin", "members": json.dumps(
    {"members": [{"ip": "100.100.100.1", "port": "443", "status": "enabled"}, {"ip": "100.100.100.2", "port": "443", "status": "disabled"}]}), "f5_ips": "", "vip_name": "", "key_file": "uploaded-file-key-1607163169.key", "cert_file": "uploaded-file-cert-1607163169.crt", "file_path_key": "uploaded-file-key-1607163169.key", "file_path_cert": "uploaded-file-cert-1607163169.crt", "username": "rasdar@delloitte.com"}

queryparams = parsed_parameters